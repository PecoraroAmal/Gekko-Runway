      ...
      <div className="card">
        <div className="heatmap-controls">
          ...
          <div className="heatmap-nav">
            <button onClick={() => setHeatmapYear((y) => y - 1)}><i className="fa-solid fa-chevron-left"></i></button>
            <span className="heatmap-period-label">{heatmapYear}</span>
            <button onClick={() => setHeatmapYear((y) => y + 1)}><i className="fa-solid fa-chevron-right"></i></button>
          </div>
        </div>
        <Heatmap year={heatmapYear} refreshToken={refreshToken} />
      </div>

      <div className="card">
        <h2 className="card-title">Saldo per conto</h2>
        {accounts.length === 0 ? (
